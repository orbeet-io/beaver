...
WARNING: this version does not change anything functonnaly BUT the output is
...
- tooling now has a `task vulncheck` which tries and find golang vulnerabilities
  for our project
- updated yaml dependencie to gopkg.in/yaml.v3 after discovering vulnerabilities
